...
\section*{Beispiel 1: Unendliches Verhalten (Polstelle)}
...
Diese Stelle wird \textbf{Polstelle} genannt.
\end{tcolorbox}
...
\section*{Beispiel 2: Endliches Verhalten (hebbare Lücke)}
...
\qquad L_1\neq L_2,
\]
so liegt eine \textbf{Sprungstelle} vor.
\end{tcolorbox}
